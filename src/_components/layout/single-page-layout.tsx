...
const SinglePageLeaf = () => {
	return (
		<>
			<BranchLeaf className="absolute top-0 right-0 z-0 size-40 2xl:size-60 rotate-x-180 text-(--primary-green)" />
			<Leaf1 className="absolute top-[60%] 2xl:top-[65%] left-[5%] z-0 size-16 2xl:size-24 text-(--primary-green) opacity-95" />
			<Leaf2 className="absolute top-[43%] 2xl:top-[20%] left-[40%] z-0 size-20 2xl:size-32 rotate-180 text-(--primary-green) opacity-95" />
			<RoundLeaf className="hidden sm:block absolute top-0 -left-[2%] z-0 size-28 2xl:size-40 rotate-180 text-(--primary-green) opacity-95" />
		</>
	)
}
