...
export default function Card({
	...
	return (
		<li
			key={element.id}
			className={`w-full sm:w-[220px] 2xl:w-[295px] flex flex-col gap-5 p-4 2xl:p-6 ${type === "shop" ? "bg-[var(--primary-pink)]" : "bg-[var(--background-one)]"} rounded-tr-4xl rounded-bl-4xl custom-shadow group border border-[#d685922a]`}
		>
			<div className="relative custom-shadow overflow-hidden rounded-tr-4xl rounded-bl-4xl w-full h-[280px] 2xl:h-[480px]">
				<ImageKit
