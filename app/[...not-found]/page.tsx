...
export default function page() {
  return (
    <div className="flex-1 flex flex-col justify-center items-center gap-3 relative">
      ...
      <p className='text-[20rem] font-extrabold tracking-widest drop-shadow-[10px_10px_10px_#00000075] text-[var(--primary-green)] leading-none'>404</p>

      <p className='text-[3rem] font-bold tracking-wide drop-shadow-[5px_5px_5px_#00000075]'>Page Not Found</p>

      <Link
        className="cta-button py-2 px-6"
        href="/"
        >
        Back
      </Link>
