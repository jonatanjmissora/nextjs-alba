...
export const SectionHeader = ({
	...
	return (
		<div className="flex items-end gap-3 header-border pb-10 mb-20 mt-10 relative">
			...
			<div className="flex flex-col gap-2">
				...
				<h2 className="w-full title font-bold text-balance leading-12 min-w-[370px]">{title}</h2>
			</div>
