	...
	return (
		<>
			...
			<div className="w-1/4 flex flex-col gap-3">
				...
				<span className="subtitle mt-4">in Bahia Blanca</span>
...
const LeafImgs = () => {
	return (
		<>
			<BranchLeaf className="absolute top-0 right-[15%] size-[20rem] 2xl:size-[25rem] rotate-x-180 text-[var(--leaf-color)] opacity-50" />
			<Leaf1 className="absolute top-[45%] left-[55%] size-[7rem] text-[var(--leaf-color)]" />
			<Leaf2 className="absolute bottom-[0%] right-[30%] size-[10rem] 2xl:size-[15rem] rotate-180 text-[var(--leaf-color)]" />
			<RoundLeaf className="absolute bottom-[28%] -left-[5%] size-[12rem] 2xl:size-[18rem] rotate-180 text-[var(--leaf-color)] opacity-50" />
		</>
	)
}
