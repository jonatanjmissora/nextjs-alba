...
export default function Certificates() {
	return (
        <div className="w-full flex justify-center items-center gap-4 pb-20">
            <div className="relative w-[220px] h-[160px] 2xl:w-[350px] 2xl:h-[200px] rounded-lg overflow-hidden hover:scale-150 transition-all duration-300 hover:z-10">
            ...
            <div className="relative overflow-hidden w-[220px] h-[160px] 2xl:w-[350px] 2xl:h-[200px] rounded-lg hover:scale-150 transition-all duration-300 hover:z-10">
